...
<table class="table">
	...
	<tr>
		<td>Informaci&oacute;n del cliente: <span id="CusTInfOSpaN"></span> &nbsp; &nbsp; &nbsp; &nbsp; 
		<?php
...
<table class="table" width="550px">
	...
	if ($label_title == '---HIDE---')
		...
		echo "$label_title: </td><td align=\"left\" colspan=\"5\"><font class=\"body_text\"><input class=\"form-control\" type=\"text\" size=\"4\" name=\"title\" id=\"title\" maxlength=\"$MAXtitle\" class=\"cust_form\" value=\"\" $title_readonly />";
		}
	...
	if ($label_address2 == '---HIDE---')
		...
		echo "$label_address2: </td><td align=\"left\"><font class=\"body_text\"><input class=\"form-control\" type=\"text\" size=\"20\" name=\"address2\" id=\"address2\" maxlength=\"$MAXaddress2\" class=\"cust_form\" value=\"\" $address2_readonly />";
		}
	...
	if ($label_address3 == '---HIDE---')
		...
		echo "$label_address3: </td><td align=\"left\" colspan=\"3\"><font class=\"body_text\"><input class=\"form-control\" type=\"text\" size=\"45\" name=\"address3\" id=\"address3\" maxlength=\"$MAXaddress3\" class=\"cust_form\" value=\"\" $address3_readonly />";
		}
