...
<span class="w-100 h-100 bg-white" style="position:fixed;left:0px;top:0px;z-index:<?php $zi++; echo $zi ?>;" id="NeWManuaLDiaLBox">
    <div class="w-50 mx-auto mt-5">
		...
		<table>
			<tr>
				<td align="center" valign="top">
					<font class="sd_text"><?php echo _QXZ("NEW MANUAL DIAL LEAD FOR %1s in campaign %2s:",0,'',$VD_login,$VD_campaign); ?></font><br /><br />
							...
							<tr>
								...
								<td align="left">
									...
									if ($manual_dial_lead_id=='Y')
										...
										echo "	<input class=\"form-control\" type=\"text\" size=\"10\" maxlength=\"10\" name=\"MDLeadIDEntry\" id=\"MDLeadIDEntry\" class=\"cust_form\" value=\"\" />&nbsp; "._QXZ("(digits only)")."</font>\n";
										}
									else
										{
