...
<TD class="px-2" VALIGN=TOP WIDTH=170 BGCOLOR=#<?php echo "$SSmenu_background" ?> ALIGN=CENTER VALIGN=MIDDLE>
	...
	if (strlen($users_hh) > 25) 
	{
		...
		?>
	<TR <?php echo $list_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=0A';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT>
		&nbsp; <a href="<?php echo $ADMIN ?>?ADD=0A" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Show Users"); ?> </a>
	</TR>
	<TR <?php echo $new_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=1';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT>
		<?php if ($add_copy_disabled < 1) { ?>
		&nbsp; <a href="<?php echo $ADMIN ?>?ADD=1" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Add A New User"); ?> </a>
	</TR>
	<TR <?php echo $copy_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=1A';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT>
		 &nbsp; <a href="<?php echo $ADMIN ?>?ADD=1A" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Copy User"); ?> </a>
	</TR>
	<TR <?php echo $search_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=550';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT>
		<?php } ?>
		&nbsp; <a href="<?php echo $ADMIN ?>?ADD=550" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Search For A User"); ?> </a>
	</TR>
	<TR <?php echo $stats_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='./user_stats.php?user=$user';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT>
		&nbsp; <a href="./user_stats.php?user=<?php echo $user ?>" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("User Stats"); ?> </a>
	</TR>
	<TR <?php echo $status_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='./user_status.php?user=$user';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT>
		&nbsp; <a href="./user_status.php?user=<?php echo $user ?>" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("User Status"); ?> </a>
	</TR>
	<TR <?php echo $sheet_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='./AST_agent_time_sheet.php?agent=$user';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT>
		&nbsp; <a href="./AST_agent_time_sheet.php?agent=<?php echo $user ?>" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Time Sheet"); ?> </a> </TD></TR>
		<?php
		if ( ($SSuser_territories_active > 0) or ($user_territories_active > 0) )
			{ ?>

	</TR>
	<TR <?php echo $territory_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='./user_territories.php?agent=$user';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT>
		&nbsp; <a href="./user_territories.php?agent=<?php echo $user ?>" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("User Territories"); ?> </a> </TD></TR>
	...
	<TR <?php echo $newlimit_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='./admin_user_list_new.php?user=---ALL---&list_id=NONE&stage=overall';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT>
		&nbsp; <a href="./admin_user_list_new.php?user=---ALL---&list_id=NONE&stage=overall" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Overall New Lead Limits"); ?> </a> </TD></TR>

	<?php }
	}
	?>
	<!-- CAMPAIGNS NAVIGATION -->
	<TR BGCOLOR=#<?php echo "$SSmenu_background "; if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=10';\"";} ?>>
	...
	if (strlen($campaigns_hh) > 25) 
		...
		<TD class="p-2" ALIGN=LEFT <?php echo $list_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=10" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Campaigns Main"); ?></a></TD>
		</TR><TR <?php echo $status_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=32';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT <?php echo $status_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=32" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Statuses"); ?></a></TD>
		</TR><TR <?php echo $hotkey_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=33';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT <?php echo $hotkey_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=33" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("HotKeys"); ?></a></TD>
		<?php
		if ($SSoutbound_autodial_active > 0)
			{
			?>
			</TR><TR <?php echo $recycle_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=35';\"";} ?>>
			<TD class="p-2" ALIGN=LEFT <?php echo $recycle_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=35" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Lead Recycle"); ?></a></TD>
			</TR><TR <?php echo $autoalt_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=36';\"";} ?>>
			<TD class="p-2" ALIGN=LEFT <?php echo $autoalt_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=36" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Auto-Alt Dial"); ?></a></TD>
			</TR><TR <?php echo $listmix_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=39';\"";} ?>>
			<TD class="p-2" ALIGN=LEFT <?php echo $listmix_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=39" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("List Mix"); ?></a></TD>
			<?php
			}
		?>
		</TR><TR <?php echo $pause_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=37';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT <?php echo $pause_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=37" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Pause Codes"); ?></a></TD>
		</TR><TR <?php echo $preset_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=301';\"";} ?>>
		<TD class="p-2" ALIGN=LEFT <?php echo $preset_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=301" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("Presets"); ?></a></TD>
		<?php
		if ($SScampaign_cid_areacodes_enabled > 0)
			...
			<TD ALIGN=LEFT <?php echo $accid_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=302" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;"><?php echo _QXZ("AC-CID"); ?></a></TD>
			<?php
			}
		 } 
	?>
	...
	if ($SSoutbound_autodial_active > 0)
		{
		?>
		<TR BGCOLOR=#<?php echo "$SSmenu_background "; if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=100';\"";} ?>>
		...
		if (strlen($lists_hh) > 25) 
			...
			<a href="<?php echo $ADMIN ?>?ADD=100" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Lists"); ?> </a>
			</TR><TR <?php echo $new_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=111';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
			<?php if ($add_copy_disabled < 1) { ?>
			<a href="<?php echo $ADMIN ?>?ADD=111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New List"); ?> </a>
			...
			<?php } ?>
			<a href="admin_search_lead.php" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Search For A Lead"); ?> </a>
			...
			<a href="admin_modify_lead.php" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Lead"); ?> </a>
			</TR><TR <?php echo $dnc_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=121';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
			<a href="<?php echo $ADMIN ?>?ADD=121" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo $DNClink ?> </a>
			...
			<a href="./admin_listloader_fourth_gen.php" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Load New Leads"); ?> </a>
			<?php
			if ($SScustom_fields_enabled > 0)
				...
				<a href="./<?php echo $admin_lists_custom ?>" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("List Custom Fields"); ?> </a>
				...
				<a href="./<?php echo $admin_lists_custom ?>?action=COPY_FIELDS_FORM" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Copy Custom Fields"); ?> </a>
				<?php
				}
			if ($SSenable_drop_lists > 0)
				...
				<a href="<?php echo $ADMIN ?>?ADD=130" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Drop Lists"); ?> </a>
				<?php
				}
			?>
			</TD></TR>
	...
	<TR <?php echo $list_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=100000000000000';\"";} ?>>
		<TD ALIGN=LEFT> &nbsp;
			<a href="<?php echo $ADMIN ?>?ADD=100000000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show QC Campaigns"); ?> </FONT></a>
		</TD>
	</TR>
	<TR <?php echo $enter_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=100000000000000';\"";} ?>>
		<TD ALIGN=LEFT> &nbsp;
			<a href="<?php echo $ADMIN ?>?ADD=100000000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Enter QC Queue"); ?> </FONT></a>
		</TD>
	</TR>
	<TR <?php echo $modify_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=341111111111111';\"";} ?>>
		<TD ALIGN=LEFT> &nbsp;
			<a href="<?php echo $ADMIN ?>?ADD=341111111111111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Modify QC Codes"); ?> </FONT></a>
		</TD>
	</TR>
		<?php }
		}
	?>
	<!-- SCRIPTS NAVIGATION -->
	<TR BGCOLOR=#<?php echo "$SSmenu_background "; if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=1000000';\"";} ?>>
	...
	if (strlen($scripts_hh) > 25) 
		...
		<a href="<?php echo $ADMIN ?>?ADD=1000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Scripts"); ?> </a>
		</TR><TR <?php echo $new_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=1111111';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo $ADMIN ?>?ADD=1111111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Script"); ?> </a>
		<?php } ?>
		</TD></TR>
		<?php } 
	?>
	...
	if ($SSoutbound_autodial_active > 0)
		{
		?>
		<TR BGCOLOR=#<?php echo "$SSmenu_background "; if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=10000000';\"";} ?>>
		...
		<a href="<?php echo $ADMIN ?>?ADD=10000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Filters"); ?> </a>
		</TR><TR <?php echo $new_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=11111111';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo $ADMIN ?>?ADD=11111111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Filter"); ?> </a>
		<?php } ?>
		</TD></TR>
		<?php } 
		}
	?>
	<!-- INGROUPS NAVIGATION -->
	<TR BGCOLOR=#<?php echo "$SSmenu_background "; if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=1001';\"";} ?>>
	...
	if (strlen($ingroups_hh) > 25) 
		...
		<a href="<?php echo $ADMIN ?>?ADD=1000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show In-Groups"); ?> </a>
		</TD></TR><TR <?php echo $newIG_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=1111';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo $ADMIN ?>?ADD=1111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New In-Group"); ?> </a>
		...
		<a href="<?php echo $ADMIN ?>?ADD=1211" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Copy In-Group"); ?> </a>
		<?php } ?>
		<?php
		...
		<a href="<?php echo $ADMIN ?>?ADD=1800" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Email Groups"); ?> </a>
		</TD></TR><TR <?php echo $newEG_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=1811';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo $ADMIN ?>?ADD=1811" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add New Email Group"); ?> </a>
		...
		<a href="<?php echo $ADMIN ?>?ADD=1911" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Copy Email Group"); ?> </a>
		<?php } ?>
		<?php
			}
		?>
		...
		<a href="<?php echo $ADMIN ?>?ADD=1900" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Chat Groups"); ?> </a>
		...
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo $ADMIN ?>?ADD=18111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add New Chat Group"); ?> </a>
		...
		<a href="<?php echo $ADMIN ?>?ADD=19111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Copy Chat Group"); ?> </a>
		<?php } ?>
		<?php
			}
		?>
		...
		<a href="<?php echo $ADMIN ?>?ADD=1300" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show DIDs"); ?> </a>
		...
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo $ADMIN ?>?ADD=1311" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New DID"); ?> </a>
		...
		<a href="<?php echo $ADMIN ?>?ADD=1411" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Copy DID"); ?> </a>
		<?php
			}
		if ($SSdid_ra_extensions_enabled > 0)
			...
			<a href="<?php echo $ADMIN ?>?ADD=1320" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"><?php echo _QXZ("RA Extensions"); ?></a>
			<?php
			}
		?>
		...
		<a href="<?php echo $ADMIN ?>?ADD=1500" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Call Menus"); ?> </a>
		</TD></TR><TR <?php echo $newCM_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=1511';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo $ADMIN ?>?ADD=1511" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Call Menu"); ?> </a>
		...
		<a href="<?php echo $ADMIN ?>?ADD=1611" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Copy Call Menu"); ?> </a>
		<?php } ?>
		...
		<a href="<?php echo $ADMIN ?>?ADD=1700" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Filter Phone Groups"); ?> </a>
		...
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo $ADMIN ?>?ADD=1711" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add Filter Phone Group"); ?> </a>
		</TD></TR><TR <?php echo $addFPG_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=171';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
		<?php } ?>
		<a href="<?php echo $ADMIN ?>?ADD=171" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo $FPGlink ?> </a>
		</TD></TR>
		<?php } 
		?>
	<!-- USERGROUPS NAVIGATION -->
	<TR BGCOLOR=#<?php echo "$SSmenu_background "; if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=100000';\"";} ?>>
	...
	if (strlen($usergroups_hh) > 25)
		...
		<a href="<?php echo $ADMIN ?>?ADD=100000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show User Groups"); ?> </a>
		</TR><TR <?php echo $new_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=111111';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo $ADMIN ?>?ADD=111111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New User Group"); ?> </a>
		...
		<?php } ?>
		<a href="group_hourly_stats.php" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Group Hourly Report"); ?> </a>
		...
		<a href="user_group_bulk_change.php" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Bulk Group Change"); ?> </a>
		</TD></TR>
		<?php } 
	?>
	<!-- REMOTEAGENTS NAVIGATION -->
	<TR BGCOLOR=#<?php echo "$SSmenu_background "; if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=10000';\"";} ?>>
	...
	if (strlen($remoteagent_hh) > 25) 
		...
		<a href="<?php echo $ADMIN ?>?ADD=10000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Remote Agents"); ?> </a>
		</TR><TR <?php echo $new_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=11111';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo $ADMIN ?>?ADD=11111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add New Remote Agents"); ?> </a>
		</TR><TR <?php echo $listEG_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=12000';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
		<?php } ?>
		<a href="<?php echo $ADMIN ?>?ADD=12000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Extension Groups"); ?> </a>
		</TR><TR <?php echo $newEG_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=12111';\"";} ?>><TD ALIGN=LEFT> &nbsp; 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo $ADMIN ?>?ADD=12111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add Extension Group"); ?> </a>
		<?php } ?>
		</TD></TR>
	<?php } 
	?>
	<!-- ADMIN NAVIGATION -->
	<TR BGCOLOR=#<?php echo "$SSmenu_background "; if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$ADMIN?ADD=999998';\"";} ?>>
	...
	if (strlen($admin_hh) > 25) 
		...
		<a href="<?php echo $ADMIN ?>?ADD=100000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Call Times"); ?> </a></TD>
		...
		<a href="<?php echo $ADMIN ?>?ADD=130000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Shifts"); ?> </a></TD>
		...
		<a href="<?php echo $ADMIN ?>?ADD=10000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Phones"); ?> </a></TD>
		...
		<a href="<?php echo $ADMIN ?>?ADD=130000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Templates"); ?> </a></TD>
		...
		<a href="<?php echo $ADMIN ?>?ADD=140000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Carriers"); ?> </a></TD>
		...
		<a href="<?php echo $ADMIN ?>?ADD=100000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Servers"); ?> </a></TD>
		...
		<a href="<?php echo $ADMIN ?>?ADD=1000000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Conferences"); ?> </a></TD>
		...
		<a href="<?php echo $ADMIN ?>?ADD=311111111111111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("System Settings"); ?> </a></TD>
		...
		<a href="<?php echo $ADMIN ?>?ADD=180000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Screen Labels"); ?> </a></TD>
		...
		<a href="<?php echo $ADMIN ?>?ADD=182000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Screen Colors"); ?> </a></TD>
		...
		<a href="<?php echo $ADMIN ?>?ADD=321111111111111" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("System Statuses"); ?> </a></TD>
		...
		<a href="<?php echo $ADMIN ?>?ADD=193000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Status Groups"); ?> </a></TD>
		<?php
		if ($SScampaign_cid_areacodes_enabled > 0)
			{
			?>
		...
		<a href="<?php echo $ADMIN ?>?ADD=196000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("CID Groups"); ?> </a></TD>
		<?php
			}
		?>
		...
		<a href="<?php echo $ADMIN ?>?ADD=170000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Voicemail"); ?> </a></TD>
		</TR>
		<?php
		if ($SSemail_enabled > 0)
			{ ?>
			...
			<a href="admin_email_accounts.php" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Email Accounts"); ?> </a></TD>
			</TR>
		<?php }
		if ( ($sounds_central_control_active > 0) or ($SSsounds_central_control_active > 0) )
			...
			<a href="audio_store.php" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Audio Store"); ?> </a></TD>
			</TR>
			...
			<a href="<?php echo $ADMIN ?>?ADD=160000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Music On Hold"); ?> </a></TD>
			</TR>
			<?php
		if ($SSenable_languages > 0)
			...
			<a href="admin_languages.php?ADD=163000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Languages"); ?> </a></TD>
			</TR>
			<?php }
			...
			<a href="admin_soundboard.php?ADD=162000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Audio Soundboards"); ?> </a></TD>
			</TR>
		...
		<?php 
			...
			<a href="admin.php?ADD=197000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("VM Message Groups"); ?> </a></TD>
			</TR>
		...
		if ($SSenable_tts_integration > 0)
			...
			<a href="<?php echo $ADMIN ?>?ADD=150000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Text To Speech"); ?> </a></TD>
			</TR>
		...
		if ($SScallcard_enabled > 0)
			...
			<a href="callcard_admin.php" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("CallCard Admin"); ?> </a></TD>
			</TR>
		...
		if ($SScontacts_enabled > 0)
			...
			<a href="<?php echo $ADMIN ?>?ADD=190000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Contacts"); ?> </a></TD>
			</TR>
		...
		<a href="<?php echo $ADMIN ?>?ADD=192000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Settings Containers"); ?> </a></TD>
		</TR>
		<?php
		if ($SSenable_auto_reports > 0)
			...
			<a href="<?php echo $ADMIN ?>?ADD=194000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Automated Reports"); ?> </a></TD>
			</TR>
		...
		if ($SSallow_ip_lists > 0)
			...
			<a href="<?php echo $ADMIN ?>?ADD=195000000000" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("IP Lists"); ?> </a></TD>
			</TR>
...
<TR BGCOLOR=#<?php echo "$SSmenu_background" ?>>
	...
	<TD class="p-2" ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo date("l F j, Y G:i:s A") ?> &nbsp; </B></TD>
</TR>
...
<TR BGCOLOR=#<?php echo "$SSmenu_background" ?>>
	...
	if ( (strlen($list_sh) > 25) and (strlen($campaigns_hh) > 25) ) { 
		?>
	<TR BGCOLOR=<?php echo $subcamp_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> &nbsp; 
		<a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=10"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Campaigns"); ?> </a> &nbsp; &nbsp; |<?php if ($add_copy_disabled < 1) { ?>
&nbsp; &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=11"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Campaign"); ?> </a> &nbsp; &nbsp; | &nbsp; &nbsp; 
		<a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=12"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Copy Campaign"); ?> </a> &nbsp; &nbsp; |<?php } ?> &nbsp; &nbsp; 
		<a class="btn btn-outline-dark" href="./AST_timeonVDADallSUMMARY.php"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Real-Time Campaigns Summary"); ?> </a></TD></TR>
		<?php }
	if ( (strlen($droplist_sh) > 25) and ($SSenable_drop_lists > 0) ) { 
		?>
	<TR BGCOLOR=<?php echo $subcamp_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=130"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Drop Lists"); ?> </a> &nbsp; &nbsp; |<?php if ($add_copy_disabled < 1) { ?>
&nbsp; &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=131"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Drop List"); ?> </a><?php } ?></TD></TR>
		<?php }
	if (strlen($times_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $times_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=100000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Call Times"); ?> </a> &nbsp;|<?php if ($add_copy_disabled < 1) { ?>
 <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Call Time"); ?> </a> &nbsp;|<?php } ?> <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=1000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show State Call Times"); ?> </a> &nbsp;|<?php if ($add_copy_disabled < 1) { ?> <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=1111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New State Call Time"); ?> </a> &nbsp;|<?php } ?> <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=1200000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Holidays"); ?> </a> &nbsp;|<?php if ($add_copy_disabled < 1) { ?> <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=1211111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add Holiday"); ?> </a><?php } ?></TD></TR>
		<?php } 
	if (strlen($shifts_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $shifts_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=130000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Shifts"); ?> </a> &nbsp;|<?php if ($add_copy_disabled < 1) { ?> <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=131111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Shift"); ?> </a><?php } ?></TD></TR>
		<?php } 
	if (strlen($phones_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $phones_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=10000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Phones"); ?> </a>&nbsp;|<?php if ($add_copy_disabled < 1) { ?>&nbsp;<a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=11111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Phone"); ?> </a>&nbsp;|<?php } ?>&nbsp;<a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=12000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Phone Alias List"); ?> </a>&nbsp;|<?php if ($add_copy_disabled < 1) { ?>&nbsp;<a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=12111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Phone Alias"); ?> </a>&nbsp;|<?php } ?>&nbsp;<a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=13000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Group Alias List"); ?> </a>&nbsp;|<?php if ($add_copy_disabled < 1) { ?>&nbsp;<a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=13111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Group Alias"); ?> </a><?php } ?></TD></TR>
		<?php }
	if (strlen($conference_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $conference_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=1000000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Conferences"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=1111111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Conference"); ?> </a> &nbsp; |<?php } ?> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=10000000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show VICIDIAL Conferences"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=11111111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New VICIDIAL Conference"); ?> </a><?php } ?></TD></TR>
		<?php }
	if ( (strlen($server_sh) > 25) and (strlen($admin_hh) > 25) ) { 
		?>
	<TR BGCOLOR=<?php echo $server_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=100000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Servers"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=111111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Server"); ?> </a><?php } ?></TD></TR>
	<?php }
	if ( (strlen($templates_sh) > 25) and (strlen($admin_hh) > 25) ) { 
		?>
	<TR BGCOLOR=<?php echo $templates_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=130000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Templates"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=131111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Template"); ?> </a><?php } ?></TD></TR>
	<?php }
	if ( (strlen($carriers_sh) > 25) and (strlen($admin_hh) > 25) ) { 
		?>
	<TR BGCOLOR=<?php echo $carriers_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=140000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Carriers"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=141111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Carrier"); ?> </a> &nbsp; | &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=140111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Copy A Carrier"); ?> </a><?php } ?></TD></TR>
	<?php }
	if ( (strlen($emails_sh) > 25) and (strlen($admin_hh) > 25) ) { 
		?>
	<TR BGCOLOR=<?php echo $emails_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a  class="btn btn-outline-dark" href="admin_email_accounts.php"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Email Accounts"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a  class="btn btn-outline-dark" href="admin_email_accounts.php?eact=ADD"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Account"); ?> </a> &nbsp; | &nbsp; <a  class="btn btn-outline-dark" href="admin_email_accounts.php?eact=COPY"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Copy An Account"); ?> </a><?php } ?></TD></TR>
	<?php }
	if ( (strlen($tts_sh) > 25) and (strlen($admin_hh) > 25) ) { 
		?>
	<TR BGCOLOR=<?php echo $tts_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=150000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show TTS Entries"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=151111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New TTS Entry"); ?> </a><?php } ?></TD></TR>
	<?php }
	if ( (strlen($cc_sh) > 25) and (strlen($admin_hh) > 25) ) { 
		?>
	<TR BGCOLOR=<?php echo $cc_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a  class="btn btn-outline-dark" href="callcard_admin.php"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("CallCard Summary"); ?> </a> &nbsp; | &nbsp; <a  class="btn btn-outline-dark" href="callcard_admin.php?action=CALLCARD_RUNS"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Runs"); ?> </a> &nbsp; | &nbsp; <a  class="btn btn-outline-dark" href="callcard_admin.php?action=CALLCARD_BATCHES"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Batches"); ?> </a> &nbsp; | &nbsp; <a  class="btn btn-outline-dark" href="callcard_admin.php?action=SEARCH"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("CallCard Search"); ?> </a> &nbsp; | &nbsp; <a  class="btn btn-outline-dark" href="callcard_report_export.php"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("CallCard Log Export"); ?> </a> &nbsp; | &nbsp; <a  class="btn btn-outline-dark" href="callcard_admin.php?action=GENERATE"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("CallCard Generate New Numbers"); ?> </a></TD></TR>
	<?php }
	if ( (strlen($moh_sh) > 25) and (strlen($admin_hh) > 25) ) { 
		?>
	<TR BGCOLOR=<?php echo $moh_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=160000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show MOH Entries"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a  class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=161111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New MOH Entry"); ?> </a><?php } ?></TD></TR>
	<?php }
	if ( (strlen($languages_sh) > 25) and (strlen($admin_hh) > 25) and ($SSenable_languages > 0) ) { 
		?>
	<TR BGCOLOR=<?php echo $languages_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a  class="btn btn-outline-dark" href="admin_languages.php?ADD=163000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Languages"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="admin_languages.php?ADD=163111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Language"); ?></FONT></a> &nbsp; | &nbsp; <a class="btn btn-outline-dark" href="admin_languages.php?ADD=163211111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Copy A Languages Entry"); ?></FONT></a> &nbsp; | &nbsp; <a class="btn btn-outline-dark" href="admin_languages.php?ADD=163311111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Import Phrases"); ?></FONT></a> &nbsp; | &nbsp; <a class="btn btn-outline-dark" href="admin_languages.php?ADD=163411111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Export Phrases"); ?></FONT></a> &nbsp; <?php } ?></TD></TR>
	<?php }
	if ( (preg_match("/soundboard/",$SSactive_modules) ) or ($SSagent_soundboards > 0) )
		{
	if ( (strlen($soundboard_sh) > 25) and (strlen($admin_hh) > 25) ) { 
		?>
	<TR BGCOLOR=<?php echo $soundboard_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="admin_soundboard.php?ADD=162000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Soundboard Entries"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="admin_soundboard.php?ADD=162111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Soundboard Entry"); ?></FONT></a> &nbsp; | &nbsp; <a class="btn btn-outline-dark" href="admin_soundboard.php?ADD=162211111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Copy A Soundboard Entry"); ?></FONT></a> &nbsp; <?php } ?></TD></TR>
	<?php
		}
	}
	if ( (strlen($vm_sh) > 25) and (strlen($admin_hh) > 25) ) { 
		?>
	<TR BGCOLOR=<?php echo $vm_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=170000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Show Voicemail Entries"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=171111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A New Voicemail Entry"); ?> </a><?php } ?></TD></TR>
	<?php }
	if (strlen($settings_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $settings_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=311111111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("System Settings"); ?> </a></TD></TR>
	<?php }
	if (strlen($label_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $label_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=180000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Screen Labels"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=181111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A Screen Label"); ?> </a><?php } ?></TD></TR>
	<?php }
	if (strlen($colors_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $colors_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=182000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Screen Colors"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=182111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A Screen Colors"); ?> </a><?php } ?> &nbsp; | &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=311111111111111#screen_colors"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Change Active Screen Colors"); ?> </a></TD></TR>
	<?php }
	if (strlen($cts_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $cts_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=190000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Contacts"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=191111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A Contact"); ?> </a><?php } ?></TD></TR>
	<?php }
	if (strlen($sc_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $sc_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=192000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Settings Containers"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=192111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A Settings Container"); ?> </a><?php } ?></TD></TR>
	<?php }
	if (strlen($ar_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $ar_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=194000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Automated Reports"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=194111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add An Automated Report"); ?> </a><?php } ?></TD></TR>
	<?php }
	if (strlen($il_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $il_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=195000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("IP Lists"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=195111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add An IP List"); ?> </a><?php } ?></TD></TR>
	<?php }
	if (strlen($sg_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $sg_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=193000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Status Groups"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=193111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A Status Group"); ?> </a><?php } ?></TD></TR>
	<?php }
	if (strlen($cg_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $cg_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=196000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("CID Groups"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=196111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A CID Group"); ?> </a><?php } ?></TD></TR>
	<?php }
	if (strlen($vmmg_sh) > 25) { 
		?>
	<TR BGCOLOR=<?php echo $vmmg_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=197000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("VM Message Groups"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=197111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Add A VM Message Group"); ?> </a><?php } ?></TD></TR>
	<?php }
	if ( (strlen($status_sh) > 25) and (!preg_match('/campaign|user/i',$hh) ) ) { 
		?>
	<TR BGCOLOR=<?php echo $status_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=321111111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("System Statuses"); ?> </a> &nbsp; | &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=331111111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("Status Categories"); ?> </a> &nbsp; | &nbsp; <a class="btn btn-outline-dark" href="<?php echo $ADMIN ?>?ADD=341111111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"> <?php echo _QXZ("QC Status Codes"); ?> </a></TD></TR>
	<?php }

	if ( ($ADD=='3') or ($ADD=='3') ) { 
		?>
	<TR BGCOLOR=<?php echo $users_color ?>><TD class="p-2" ALIGN=LEFT COLSPAN=2> &nbsp; <a class="btn btn-outline-dark" href="./user_stats.php?user=<?php echo $user ?>" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"><?php echo _QXZ("User Stats"); ?> </a> &nbsp; | &nbsp; <a class="btn btn-outline-dark" href="./user_status.php?user=<?php echo $user ?>" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"><?php echo _QXZ("User Status"); ?> </a> &nbsp; | &nbsp; <a class="btn btn-outline-dark" href="./AST_agent_time_sheet.php?agent=<?php echo $user ?>" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"><?php echo _QXZ("Time Sheet"); ?> </a> &nbsp; | &nbsp; <a class="btn btn-outline-dark" href="./AST_agent_days_detail.php?user=<?php echo $user ?>" STYLE="text-decoration:none;"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"><?php echo _QXZ("Days Status"); ?> </a></TD></TR>
	<?php }
